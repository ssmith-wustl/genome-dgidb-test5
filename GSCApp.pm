...
App::Vocabulary->vocabulary(qw/GSC DNA NCBI FPC ID ABI SCF GB PSE MD PCR cDNA mRNA tRNA QStat ZTR NIH NHGRI MP FTP IPR HTMP QA AB1 ETL OLTP OLAP NSF CDS UTR SFF TA TCGA RNA/);
