...
GENOME_DEV_MODE=1 perl /gscuser/jlolofie/dev/git/clean_genome/genome-webserver/solr/scripts/gcsearch_load_from_db.pl --add flowcell --lock 4 --chunk $i
done
...
#GENOME_DEV_MODE=1 perl /gscuser/jlolofie/dev/git/clean_genome/genome-webserver/solr/scripts/gcsearch_load_from_db.pl --add model --lock 1 --chunk $i
#done
