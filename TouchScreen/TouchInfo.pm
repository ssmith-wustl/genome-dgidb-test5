			      ...
			      'pick' => {'96 archive plate' => {'SqlPackage'    => 'TouchScreen::NewProdSql',
					 ...
					 '384 archive plate' => {'SqlPackage'    => 'TouchScreen::NewProdSql',
								 ...
								 'PostConfirmOperation' => 'AutoAbandonAgarPlates',
                                         ...
                                         'ribosomal to A1-384 archive plate' => {'SqlPackage'    => 'TouchScreen::NewProdSql',
                                                                                 'Configuration' => 'OneToMany',
                                                                                 'Headers'       => ['Agar Plate', '384 well archive plates'],
                                                                                 'InputCheck'    => 'GetAvailPlasmidAgarPlateToPick384',
                                                                                 'OutputCheck'   => 'CheckOutput384A1',
                                                                                 'Confirm'       => 'Pick384ProductionArchiveA1',
                                                                                 'PostConfirmOperation' => 'AutoAbandonAgarPlates',
                                                                             },
                                         'ribosomal to A2-384 archive plate' => {'SqlPackage'    => 'TouchScreen::NewProdSql',
                                                                                 'Configuration' => 'OneToMany',
                                                                                 'Headers'       => ['Agar Plate', '384 well archive plates'],
                                                                                 'InputCheck'    => 'GetAvailPlasmidAgarPlateToPick384',
                                                                                 'OutputCheck'   => 'CheckOutput384A2',
                                                                                 'Confirm'       => 'Pick384ProductionArchiveA2',
                                                                                 'PostConfirmOperation' => 'AutoAbandonAgarPlates',
                                                                             },
                                         'ribosomal to B1-384 archive plate' => {'SqlPackage'    => 'TouchScreen::NewProdSql',
                                                                                 'Configuration' => 'OneToMany',
                                                                                 'Headers'       => ['Agar Plate', '384 well archive plates'],
                                                                                 'InputCheck'    => 'GetAvailPlasmidAgarPlateToPick384',
                                                                                 'OutputCheck'   => 'CheckOutput384B1',
                                                                                 'Confirm'       => 'Pick384ProductionArchiveB1',
                                                                                 'PostConfirmOperation' => 'AutoAbandonAgarPlates',
                                                                             },
                                         'ribosomal to B2-384 archive plate' => {'SqlPackage'    => 'TouchScreen::NewProdSql',
                                                                                 'Configuration' => 'OneToMany',
                                                                                 'Headers'       => ['Agar Plate', '384 well archive plates'],
                                                                                 'InputCheck'    => 'GetAvailPlasmidAgarPlateToPick384',
                                                                                 'OutputCheck'   => 'CheckOutput384B2',
                                                                                 'Confirm'       => 'Pick384ProductionArchiveB2',
                                                                                 'PostConfirmOperation' => 'AutoAbandonAgarPlates',
                                                                             },
                                         'incoming dna to A1-384 archive plate' => {'SqlPackage'    => 'TouchScreen::NewProdSql',
                                                                                    'Configuration' => 'OneToMany',
                                                                                    'Headers'       => ['Agar Plate', '384 well archive plates'],
                                                                                    'InputCheck'    => 'GetAvailPlasmidAgarPlateToPick384',
                                                                                    'OutputCheck'   => 'CheckOutput384A1',
                                         ...
                                         'incoming dna to A2-384 archive plate' => {'SqlPackage'    => 'TouchScreen::NewProdSql',
                                                                                    'Configuration' => 'OneToMany',
                                                                                    'Headers'       => ['Agar Plate', '384 well archive plates'],
                                                                                    'InputCheck'    => 'GetAvailPlasmidAgarPlateToPick384',
                                                                                    'OutputCheck'   => 'CheckOutput384A2',
                                         ...
                                         'incoming dna to B1-384 archive plate' => {'SqlPackage'    => 'TouchScreen::NewProdSql',
                                                                                    'Configuration' => 'OneToMany',
                                                                                    'Headers'       => ['Agar Plate', '384 well archive plates'],
                                                                                    'InputCheck'    => 'GetAvailPlasmidAgarPlateToPick384',
                                                                                    'OutputCheck'   => 'CheckOutput384B1',
                                         ...
                                         'incoming dna to B2-384 archive plate' => {'SqlPackage'    => 'TouchScreen::NewProdSql',
                                                                                    'Configuration' => 'OneToMany',
                                                                                    'Headers'       => ['Agar Plate', '384 well archive plates'],
                                                                                    'InputCheck'    => 'GetAvailPlasmidAgarPlateToPick384',
                                                                                    'OutputCheck'   => 'CheckOutput384B2',
