...
use GAP::DB::Organism;
use GAP::DB::SequenceSet;


$GAP::DB::DBI::db_env = 'dev';

my $organism = GAP::DB::Organism->insert({
...
my $sequence_set = GAP::DB::SequenceSet->insert({
...
foreach my $i (1..10) {
    ...
    my $sequence = GAP::DB::Sequence->insert({
    ...
    for my $j (1..100) {
        ...
        my $coding_gene = GAP::DB::CodingGene->insert({
        ...
        my $protein = GAP::DB::Protein->insert({
