...
package Bio::ContigUtilities::Transform;
our $VERSION = 0.01;
...
my $pkg = "Bio::ContigUtilities::Transform";
...
sub get_pad_position#($unpadded_position, $offset)#returns Padded Position in string 3
{
	...
	return ${$transform->{unpadded_to_padded}}[$pad_string_position-1]+1;		
}
...
sub get_unpad_position
{
	...
	return ${$transform->{padded_to_unpadded}}[$padded_position-1]+1;
}
